...
public class UI_CreateCharacterWindow : UI_WindowBase
{
    ...
    private void BackButtonClick()
    {
        ...
        SceneSystem.LoadSceneAsync("Menu", LoadProgress);
        JKFrame.EventSystem.AddEventListener("LoadSceneSucceed", LoadSceneSucceed);
    }
    private void SubmitButtonClick()
    {
        UISystem.Close<UI_CreateCharacterWindow>();
        GameManager.Instance.PlayerProfession = currentProfessionButton.ProfessionType;
        // 保存数据
        DataManager.SaveCustomCharacterData();
        DataManager.SavePlayerProfessionData();
        // 进入游戏场景
        loadUIWindow = UISystem.Show<UI_LoadProcessWindow>();
